...
A proposta da Anthropic para segurança indica que a próxima fase da AppSec será menos relatório parado e mais correção guiada.

A notícia vem de Anthropic, em publicação de maio de 2026. O ponto central não é apenas o anúncio em si. É o sinal de direção: tecnologia está saindo da fase de demonstração e entrando em infraestrutura, operação, segurança, produto e receita.

## O que aconteceu

O problema de segurança não é só detectar falhas. É transformar achado em patch revisável.
...
Times pequenos acumulam alertas porque não têm tempo para investigar, validar e corrigir tudo com qualidade.
...
Ferramentas de IA podem ajudar a priorizar riscos, explicar impacto e sugerir correções, desde que passem por revisão humana.
...
O futuro da AppSec com IA será medido por tempo até correção, não por quantidade de alertas.
