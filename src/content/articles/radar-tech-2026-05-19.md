...
### 6. Capital está correndo para infraestrutura de IA
...
Hacker News publicou ou destacou: "Show HN: Forge – Guardrails take an 8B model from 53% to 99% on agentic tasks". O tema entra no radar porque conversa com IA aplicada, automação e negócios digitais.
