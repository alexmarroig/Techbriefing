...
**Fonte:** [TechCrunch AI](https://techcrunch.com/2026/05/13/notion-just-turned-its-workspace-into-a-hub-for-ai-agents/)  
**Título em português:** Agentes de IA entram em uma nova fase operacional  
**Título original:** Notion just turned its workspace into a hub for AI agents
...
### 9. Eficiência de tokens virou vantagem competitiva em agentes
...
### 11. Vibe coding está virando método de aprendizado para agentes
...
### 12. O movimento merece atenção de quem usa tecnologia no negócio

**Fonte:** [OpenAI News](https://openai.com/index/building-codex-windows-sandbox)  
**Título em português:** O movimento merece atenção de quem usa tecnologia no negócio  
**Título original:** Building a safe, effective sandbox to enable Codex on Windows
