      ...
      <div className="wrap">
        <div className="nl-cta-inner">
          ...
          <p className="nl-cta-sub">
            Guias práticos, ferramentas testadas e estratégia de IA aplicada —
            sem hype, sem enrolação e sem promessa vazia.
          </p>

          {done ? (
            <div style={{textAlign:'center',padding:'24px',fontFamily:'var(--serif)',fontSize:24,color:'var(--amber)'}}>
              ✓ Você está no Briefing!
            </div>
          ) : (
            <form
              className="nl-cta-form"
              onSubmit={e=>{
                e.preventDefault();
          ...
          <div style={{marginTop:14,fontFamily:'var(--mono)',fontSize:11,color:'var(--text-4)',letterSpacing:'.04em'}}>
            LGPD · Cancele quando quiser · Sem spam
          </div>
        </div>
      </div>
    </section>
  ...
  return (
    <>
          ...
          <div className="about-hero-inner">
            <div>
              <div className="about-hero-eyebrow">
                ...
                <span className="about-hero-eyebrow-text">A Referência</span>
              </div>

              <h1 className="about-hero-title">
                Onde a IA encontra a
                <br/>
                <em>Operação Real.</em>
              </h1>

              <p className="about-hero-sub">
                O TechBriefing não é um portal de notícias. É um laboratório editorial focado em transformar a complexidade da Inteligência Artificial em vantagem competitiva e ROI operacional para empresas e profissionais.
              </p>
            </div>
          ...
          <div className="mission-inner">
            ...
            <div>
              ...
              <div className="mission-body">
                <p>
                  O TechBriefing nasceu de uma necessidade clara: <strong>separar o hype da utilidade</strong>. Em um mercado saturado de promessas de IA, nós focamos no que pode ser implementado hoje para reduzir custos e aumentar a escala operacional.
                </p>

                <p>
                  Nossa abordagem é a de um <strong>praticante</strong>. Não apenas relatamos o que as Big Techs estão lançando; nós quebramos o código, testamos as integrações e documentamos o processo para que você não precise cometer os mesmos erros.
                </p>

                <p>
                  Tratamos o TechBriefing como um <strong>produto editorial premium</strong>, onde a curadoria e a profundidade superam o volume. Se está no nosso radar, é porque tem potencial de impacto real no seu negócio.
                </p>
              </div>

              <a href="/metodologia" className="arrow-link">
                Conheça nossa metodologia de teste →
              </a>
            </div>
          </div>
        </div>
      ...
      <section className="values">
        <div className="wrap">
          <div style={{fontFamily:'var(--serif)',fontSize:'clamp(28px,4vw,44px)',fontWeight:700,letterSpacing:'-.02em'}}>
            O que nos guia
          </div>
      ...
      <section className="editorial">
        <div className="wrap">
          <div style={{fontFamily:'var(--serif)',fontSize:'clamp(28px,4vw,44px)',fontWeight:700,letterSpacing:'-.02em',marginBottom:0}}>
          ...
          <div className="contact-inner">
            <div>
              ...
              <p className="contact-desc">
                Para sugestões editoriais, parcerias estratégicas ou feedback técnico sobre nossas automações.
              </p>
            ...
            <div style={{background:'var(--bg-2)',border:'1px solid var(--line-s)',borderRadius:16,padding:36}}>
              <div style={{fontFamily:'var(--mono)',fontSize:11,fontWeight:600,letterSpacing:'.1em',textTransform:'uppercase',color:'var(--amber)',marginBottom:16}}>
                Media Kit 2026
              </div>

              <div style={{fontFamily:'var(--serif)',fontSize:'clamp(22px,2.5vw,28px)',fontWeight:700,letterSpacing:'-.02em',lineHeight:1.2,marginBottom:14}}>
                Alcance quem lidera a adoção de IA.
              </div>

              <div style={{fontSize:14,color:'var(--text-2)',lineHeight:1.7,marginBottom:24}}>
                Nosso público é composto por decisores, engenheiros de operações e fundadores que buscam escala. Não vendemos cliques, vendemos atenção qualificada.
              </div>

              <div style={{display:'flex',flexDirection:'column',gap:10,marginBottom:24}}>
                {[
                  'Briefing semanal para decisores',
                  'Reviews e native advertising identificados',
                  'Sponsorships de longo prazo',
                  'Comparativos e guias patrocinados',
                ].map((i,k)=>(
