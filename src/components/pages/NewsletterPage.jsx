    ...
    return (
      <div className="nl-success">
        ...
        <div className="nl-success-sub">
          Confirme seu e-mail — a primeira edição chega na próxima quinta-feira.
        </div>
      </div>
    );
  }
  ...
  return (
    <>
      <section className="nl-hero">
        ...
        <div className="nl-hero-inner">
          <div className="nl-hero-eyebrow">
            <div className="nl-hero-rule"/>
            <span className="nl-hero-eyebrow-text">Newsletter gratuita</span>
            <div className="nl-hero-rule"/>
          </div>
          ...
          <p className="nl-hero-sub">
            Guias práticos, ferramentas testadas e análises honestas sobre inteligência artificial e automação — para quem quer aplicar, não apenas ler.
          </p>
        ...
        <div className="nl-hero-bottom wrap">
          {[
            {n:'IA',em:'',l:'Aplicada'},
            {n:'Guias',em:'',l:'Práticos'},
            {n:'100%',em:'',l:'Gratuita'},
            {n:'1×',em:'',l:'Por semana'}
          ].map((s,i)=>(
            <div className="nl-hb-item" key={i}>
              <div className="nl-hb-n">
                {s.n}
                {s.em && <em>{s.em}</em>}
              </div>
      ...
      <section className="nl-topics">
        <div className="wrap">
          <div className="nl-topics-header">
            ...
            <a href="/arquivo" className="arrow-link">
              Ver todos os guias →
            </a>
          </div>
          ...
          <div className="nl-topics-list">
            {TOPICS.map((t,i)=>(
              <a
                className="nl-topic-row"
                href={t.href}
                key={i}
                aria-label={`Ler: ${t.title}`}
              >
                <div className="nl-topic-num">0{i+1}</div>
                <div className="nl-topic-title">{t.title}</div>
                <span className={`pill ${t.v} nl-topic-pill`}>
                  {t.tag}
                </span>
              </a>
            ))}
      ...
      <section className="nl-audience">
        <div className="wrap">
          <div className="nl-audience-inner">
            <div>
              <div
                style={{
                  fontFamily:'var(--mono)',
              ...
              <h2 className="nl-audience-title">
                Feita para quem
                <br/>
                <em>aplica, não só lê.</em>
              </h2>

              <p className="nl-audience-desc">
                O Tech Briefing não é para pesquisadores de IA. É para quem quer usar tecnologia no dia a dia — no trabalho, no negócio, nos projetos pessoais.
              </p>

              <div className="nl-audience-tags">
                {AUDIENCE.map(a=>(
                  <span key={a} className="pill" style={{marginBottom:6}}>
                    {a}
                  </span>
                ))}
              </div>
            ...
            <div className="nl-audience-form">
              ...
              <div className="nl-audience-form-sub">
                Gratuita. Toda quinta-feira. Cancele quando quiser.
              </div>
      ...
      <section className="nl-final">
        <div className="wrap">
          <div className="nl-final-inner">
            <h2 className="nl-final-title">
              IA aplicada.
              <br/>
              <em>Toda semana.</em>
              <br/>
            ...
            <p className="nl-final-sub">
              Nenhum motivo para esperar. Assine agora e receba a próxima edição na quinta-feira.
            </p>
