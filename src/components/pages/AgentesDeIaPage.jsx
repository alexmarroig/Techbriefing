...
const FEATURE_ART = {
  ...
  date:'28 abr 2026',
  readTime:'14 min',
  href:'/artigos/autogpt-crewai-langgraph',
...
const ASIDE = [
  {
    tag:'Tutorial',
    v:'c',
    title:'Como criar um agente ReAct do zero com LangChain',
    date:'25 abr',
    rt:'9 min',
    href:'/artigos/langchain-tutorial-portugues'
  },
  {
    tag:'Análise',
    v:'',
    title:'O que mudou no GPT-4o para uso em agentes autônomos',
    date:'22 abr',
    rt:'6 min',
    href:'/artigos/futuro-da-ia-nos-negocios'
  },
  {
    tag:'Agentes',
    v:'c',
    title:'Multi-agente vs. agente único: quando cada um faz sentido',
    date:'18 abr',
    rt:'8 min',
    href:'/artigos/multi-agente-vs-agente-unico'
  },
];
...
const ARTS = [
  {
    tag:'Tutorial',
    v:'c',
    title:'Construindo um agente de pesquisa com n8n e Claude 3.7',
    excerpt:'Passo a passo completo para criar um agente que pesquisa, sintetiza e entrega resultados.',
    date:'26 abr',
    rt:'10 min',
  ...
  },
  {
    tag:'Agentes',
    v:'c',
    title:'Orquestração de agentes: o guia que você não encontra em lugar nenhum',
    excerpt:'Arquiteturas, padrões de comunicação e como evitar os erros mais comuns.',
    date:'23 abr',
    rt:'12 min',
    href:'/artigos/agentes-ia-nao-sao-chatbots',
    image:'/images/editorial/api-components.svg'
  },
  {
    tag:'Análise',
    v:'',
    title:'Por que a maioria dos agentes de IA falha em produção',
    excerpt:'Os problemas reais que aparecem depois do tutorial — e como resolver cada um.',
    date:'20 abr',
    rt:'7 min',
    href:'/artigos/erro-automacoes-com-ia-quebram',
...
const ART_LIST = [
  {
    ...
    tag:'Caso de uso',
    v:'',
    title:'Agentes de IA para atendimento ao cliente: o que funciona de verdade',
    date:'17 abr',
    rt:'8 min',
    href:'/artigos/agentes-ia-para-vendas'
  },
  {
    num:'05',
    tag:'Tutorial',
    v:'c',
    title:'RAG com agentes: quando recuperar contexto muda tudo',
    date:'14 abr',
    rt:'11 min',
    href:'/artigos/rag-explicado-guia-pratico'
  },
  {
    num:'06',
    tag:'Ferramentas',
    v:'',
    title:'Relevance AI vs Voiceflow: qual plataforma usar para seus agentes',
    date:'11 abr',
    rt:'9 min',
    href:'/comparativos/relevance-ai-vs-voiceflow'
  },
  {
    num:'07',
    tag:'Estratégia',
    v:'a',
    title:'Como monetizar agentes de IA no seu negócio em 2026',
    date:'8 abr',
    rt:'6 min',
    href:'/artigos/agentes-ia-oferta-servico'
  },
  {
    num:'08',
    tag:'Agentes',
    v:'c',
    title:'Memory e contexto em agentes de longa duração',
    date:'5 abr',
    rt:'10 min',
    href:'/artigos/multi-agente-vs-agente-unico'
  },
...
const GUIDES = [
  {
    tag:'Guia',
    v:'a',
    title:'Do zero ao agente em produção: o roadmap completo',
    desc:'Infraestrutura, escolha de framework, deploy e monitoramento.',
    href:'/artigos/o-que-sao-agentes-de-ia'
  },
  {
    tag:'Comparativo',
    v:'',
    title:'Comparativo completo: AutoGPT vs CrewAI vs LangGraph vs Relevance',
    desc:'Testamos os quatro em 6 cenários diferentes. Veja os resultados.',
    href:'/comparativo'
  },
  {
    tag:'Tutorial',
    v:'c',
    title:'Construindo um time de agentes especializados com CrewAI',
    desc:'Como dividir tarefas complexas entre agentes que colaboram.',
    href:'/artigos/automacao-agentes-sem-codigo'
  },
  {
    tag:'Guia',
    v:'a',
    title:'Avaliação e debug de agentes: como saber se está funcionando',
    desc:'Métricas, logs e ferramentas para monitorar agentes em produção.',
    href:'/artigos/erro-automacoes-com-ia-quebram'
  },
];
...
const TOOLS = [
  {
    ico:'🤖',
    name:'Relevance AI',
    desc:'A plataforma mais acessível para criar e orquestrar agentes sem código. Interface visual, templates prontos e integrações nativas.',
    stars:'★★★★★',
    aff:true
  },
  {
    ico:'🔗',
    name:'n8n + AI',
    desc:'Combine automação visual com LLMs. Ideal para agentes que precisam integrar APIs, bancos de dados e sistemas externos.',
    stars:'★★★★★',
    aff:true
  },
  {
    ico:'⚙️',
    name:'LangSmith',
    desc:'Monitoramento e debug de aplicações com LLM. Essencial para qualquer agente em produção que você precisar debugar.',
    stars:'★★★★☆',
    aff:false
  },
  {
    ico:'🧠',
    name:'LlamaIndex',
    desc:'Framework para RAG e agentes com acesso a dados. Melhor opção quando seu agente precisa de contexto de documentos.',
    stars:'★★★★☆',
    aff:true
  },
];
    ...
    <div className="sh">
      ...
      {more && (
        <>
          ...
          <a href={moreHref || "/arquivo"} className="sh-more">
            {more} -&gt;
          </a>
        </>
      )}
        ...
        <div className="feature-grid">
          <div>
            <a className="feature-img" href={FEATURE_ART.href}>
              <img
                src={FEATURE_ART.image}
                alt={FEATURE_ART.title}
                loading="lazy"
              />
            </a>

            <div className="feature-tags">
              {FEATURE_ART.tags.map((t,i)=>(
                <span key={i} className={`pill ${t.v}`}>
                  {t.l}
                </span>
              ))}
            </div>
            ...
            <a href={FEATURE_ART.href} className="arrow-link">
              Ler artigo completo -&gt;
            </a>
          </div>
    ...
    <section className="recent">
      <div className="wrap">
        ...
        <div style={{marginTop:36,display:'flex',justifyContent:'center'}}>
          <a href="/arquivo" className="btn btn-stroke">
  ...
  return (
    <section className="tools">
      <div className="wrap">
        <SH
          num="04"
          label="Ferramentas para Agentes de IA"
          more="Ver todas"
          moreHref="/ferramentas"
        />
      ...
      <div className="wrap">
        <div className="nl-strip-inner">
          <div className="nl-strip-left">
            <div className="nl-strip-eyebrow">
              Newsletter semanal
            </div>

            <div className="nl-strip-title">
              Novidades sobre agentes
              <br/>
              <em>direto na sua caixa.</em>
            </div>

            <div className="nl-strip-sub">
          ...
          {done ? (
            ...
            >
              ...
              <div className="nl-strip-note">
                Conteúdo editorial sobre IA aplicada · LGPD · Cancele quando quiser
              </div>
            </form>
          )}
        </div>
